...
impl Widget for Warp {
    fn render(&mut self, ui: &imgui::Ui) {
            ...
            .begin_popup()
        {
            ...
            let _tok = ui.push_item_width(-1.);
            if let Some(_combo) = ui.begin_combo_with_flags(
                "##warp-graces",
...
const GRACES: &[(&str, u32)] = &[
    ...
    ("[石舞台] 濒毁玛莉卡", 19002950),
    ("[墓地平原] 贝瑞特监牢", 41002950),
    ("[墓地平原] 城的前方", 2047442950),
    ("[墓地平原] 崖上道路的终点", 2045412950),
    ("[墓地平原] 龙洞", 43012950),
    ("[墓地平原] 龙洞（终点）", 43012951),
    ("[墓地平原] 艾拉克河洞窟", 2047432950),
    ("[墓地平原] 艾拉克河下游", 2047412951),
    ("[墓地平原] 雾谷地下墓地", 40002950),
    ("[墓地平原] 墓地平原", 2046402950),
    ("[墓地平原] 大桥北方", 2046442950),
    ("[墓地平原] 正门前方的十字记号", 2045422950),
    ("[墓地平原] 通柱坡的十字记号", 2048432950),
    ("[墓地平原] 通柱坡中段", 2048422950),
    ("[墓地平原] 河尾洞窟", 43002950),
    ("[墓地平原] 熔岩管锻造遗迹", 42002950),
    ("[墓地平原] 火吻废墟", 2047412950),
    ("[墓地平原] 三叉口的十字记号", 2046422950),
    ("[“塔之镇”贝瑞特] “塔之镇”贝瑞特", 20002951),
    ("[“塔之镇”贝瑞特] 民宅小祭坛", 20002952),
    ("[“塔之镇”贝瑞特] 舞台前方", 20002953),
    ("[“塔之镇”贝瑞特] 神兽舞台", 20002950),
    ("[恩希斯城] 恩希斯城（关卡）", 2047442951),
    ("[恩希斯城] 城主的房间", 2048442951),
    ("[恩希斯城] 恩希斯赏月地", 2048442950),
    ("[卡罗隐藏墓地] 卡罗隐藏墓地", 2048392951),
    ("[卡罗隐藏墓地] 喟叹监牢", 41022950),
    ("[青蓝海岸] 青蓝海岸", 2048392950),
    ("[青蓝海岸] 青蓝海岸的十字记号", 2048372950),
    ("[青蓝海岸] 青蓝海岸西边", 2046392950),
    ("[青蓝海岸] 利亚指头遗迹", 2050382950),
    ("[青蓝海岸] 大洞", 2047352950),
    ("[石棺大洞] 大洞的十字记号", 22002952),
    ("[石棺大洞] 大洞深处", 22002954),
    ("[石棺大洞] 大洞中段", 22002953),
    ("[石棺大洞] 深紫花园", 22002950),
    ("[石棺大洞] 石棺大洞", 22002951),
    ("[尖刺山的山脚] 尖刺山的山脚", 2052402950),
    ("[尖刺山的山脚] 龙飨大祭坛", 2049392950),
    ("[尖刺山] 尖刺山（中段）", 2053392950),
    ("[尖刺山] 尖刺山（山顶）", 2054392950),
    ("[尖刺山] 狂龙之席", 2055392950),
    ("[劳弗下方] 古遗迹下方", 2048472950),
    ("[劳弗下方] 峡谷北方", 2045472950),
    ("[劳弗下方] 蝎河地下墓地", 40012950),
    ("[劳弗下方] 泰乌尔锻造遗迹", 42032950),
    ("[劳弗下方] 神殿镇废墟", 2045462950),
    ("[幽影亚坛] 惩罚要塞（后方）", 2049432952),
    ("[幽影亚坛] 波尼监牢", 41012950),
    ("[幽影亚坛] 波尼村", 2049442951),
    ("[幽影亚坛] 通村吊桥", 2051442950),
    ("[幽影亚坛] 城底积水处", 2049472950),
    ("[幽影亚坛] 玛努斯·美特大教堂", 2051452950),
    ("[幽影亚坛] 教区大道", 2051472950),
    ("[幽影亚坛] 驱暗地下墓地", 40022950),
    ("[幽影亚坛] 指头产房", 25002950),
    ("[幽影亚坛] 惩罚要塞", 2049432951),
    ("[幽影亚坛] 大道旁的十字记号", 2048452950),
    ("[幽影亚坛] 穆斯大道（南方）", 2049432950),
    ("[幽影亚坛] 穆斯废墟", 2049442950),
    ("[幽影亚坛] 隐者河下游", 2050442950),
    ("[幽影亚坛] 隐者河上游", 2050452950),
    ("[幽影亚坛] 古铁陨石锻造遗迹", 42022950),
    ("[幽影亚坛] 幽影亚坛（西方）", 2047452950),
    ("[幽影亚坛] 远望幽影树的十字记号", 2050432950),
    ("[幽影城] 正门广场", 21002951),
    ("[幽影城] 幽影城（正门）", 21002952),
    ("[幽影城（教区）] 教区入口", 21002956),
    ("[幽影城（教区）] 沉水礼拜堂", 21002957),
    ("[幽影城（教区）] 礼树暗道", 21002958),
    ("[幽影城（教区）] 礼树教堂", 21002959),
    ("[物种保藏库] 暗室门前", 21012954),
    ("[物种保藏库] 梅瑟莫的暗室", 21012950),
    ("[物种保藏库] 保藏库（内区）", 21012956),
    ("[物种保藏库] 保藏库（一楼）", 21012951),
    ("[物种保藏库] 保藏库（四楼）", 21012952),
    ("[物种保藏库] 保藏库（阁楼）", 21012957),
    ("[物种保藏库] 保藏库（七楼）", 21012953),
    ("[物种保藏库] 西边城墙", 21022951),
    ("[望影露台] 指岩山丘", 2051482950),
    ("[望影露台] 隐匿之地", 2050482950),
    ("[望影露台] 隐匿之地（桥边）", 2051482951),
    ("[望影露台] 幽影树的树脚", 2050482951),
    ("[望影露台] 望影露台", 2049482950),
    ("[望影露台] 幽影城（后门）", 2049482951),
    ("[劳弗古遗迹] 古遗迹（大楼梯）", 2044452950),
    ("[劳弗古遗迹] 花蕾教堂", 2044452951),
    ("[劳弗古遗迹] 花蕾教堂（正门口）", 2044462950),
    ("[劳弗古遗迹] 劳弗古遗迹（东方）", 2046472950),
    ("[劳弗古遗迹] 劳弗古遗迹（西方）", 2045452951),
    ("[劳弗古遗迹] 高架桥的小塔", 2047472950),
    ("[米德拉府邸] 对谈室", 28002950),
    ("[米德拉府邸] 府邸大厅", 28002951),
    ("[米德拉府邸] 米德拉的书库", 28002952),
    ("[米德拉府邸] 二楼小房间", 28002953),
    ("[谷底森林] 谷底森林", 2050422950),
    ("[谷底森林] 废弃教堂", 2053412950),
    ("[谷底森林] 水帘瀑布", 2048432951),
    ("[谷底森林] 荒废墓地", 2052432950),
    ("[谷底森林] 林中兽径", 2051422950),
    ("[艾尼尔·伊利姆] 净身厅前室", 20012955),
    ("[艾尼尔·伊利姆] 神之门（门前楼梯平台）", 20012956),
    ("[艾尼尔·伊利姆] 艾尼尔·伊利姆外墙", 20012952),
    ("[艾尼尔·伊利姆] 第一塔", 20012953),
